              ...
              <table class="c-search__form-table">
                <tr>
                  ...
                  <td>
                    ...
                    ?>
                    <label><input type="checkbox" value="<?php echo esc_attr($measuring_term->slug); ?>" name="tag[]"<?php if(in_array($measuring_term->slug, (array)$useful_tag)):?> checked<?php endif; ?>><span><?php echo $measuring_term->name; ?></span></label>
                    <?php endforeach; ?>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    ?>
                    <label><input type="checkbox" value="<?php echo esc_attr($application_term->slug); ?>" name="tag[]"<?php if(in_array($application_term->slug, (array)$useful_tag)):?> checked<?php endif; ?>><span><?php echo $application_term->name; ?></span></label>
                    <?php endforeach; ?>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    <label><input type="checkbox" value="<?php echo esc_attr($solution_term->slug); ?>" name="tag[]"<?php if(in_array($solution_term->slug, (array)$useful_tag)):?> checked<?php endif; ?>><span><?php echo $solution_term->name; ?></span></label>
                    <?php endforeach; ?>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    <label><input type="checkbox" value="<?php echo esc_attr($event_term->slug); ?>" name="tag[]"<?php if(in_array($event_term->slug, (array)$useful_tag)):?> checked<?php endif; ?>><span><?php echo $event_term->name; ?></span></label>
                    <?php endforeach; ?>
                  </td>
                </tr>
              </table>
              <a href="<?php echo esc_url(home_url()); ?>/useful/column/" class="c-search__cancel">×<?php if('en_US' == $locale):?>Unrefine your search<?php else: ?>絞り込みを解除する<?php endif; ?></a>
